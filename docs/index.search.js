var relearn_search_index = [
  ...
  },
  {
    ...
    "uri": "/windows_settings/ssh_settings_wsl/index.html"
  },
  {
  ...
  {
    "content": "Ubuntu 22.04 LTS /etc/environment export no_proxy=localhost,127.0.0.1,localhost,*\u003cdomain\u003e export ftp_proxy=http://\u003cproxy server\u003e:\u003cport\u003e/ export http_proxy=http://\u003cproxy server\u003e:\u003cport\u003e/ export https_proxy=http://\u003cproxy server\u003e:\u003cport\u003e/ export all_proxy=socks://\u003cproxy server\u003e:\u003cport\u003e/ export FTP_PROXY=http://\u003cproxy server\u003e:\u003cport\u003e/ export HTTP_PROXY=http://\u003cproxy server\u003e:\u003cport\u003e/ export HTTPS_PROXY=http://\u003cproxy server\u003e:\u003cport\u003e/ export ALL_PROXY=socks://\u003cproxy server\u003e:\u003cport\u003e/ apt /etc/apt/apt.confに以下を追記\nAcquire::http::Proxy \"http://proxy.cc.yamaguchi-u.ac.jp:8080/\"; Discord whereis discordでパスを確認 上記で確認したディレクトリ下にあるdiscord.desktopのExec=/usr/share/discord/Discord部分を以下のように書き換え Exec=env http_proxy=http://\u003cproxy-server\u003e:\u003cport\u003e https_proxy=http://\u003cproxy-server\u003e:\u003cport\u003e /usr/share/discord/Discord --proxy-server=\"http://\u003cproxy-server\u003e:\u003cport\u003e\" reboot Windows for Linux /etc/environment http_proxy=http://\u003cproxy\u003e:\u003cport\u003e https_proxy=https://\u003cproxy\u003e:\u003cport\u003e /etc/bash.bashrc export http_proxy=http://\u003cproxy\u003e:\u003cport\u003e export https_proxy=https://\u003cproxy\u003e:\u003cport\u003e /etc/apt/apt.conf Acquire::http::Proxy \"http://\u003cproxy\u003e:\u003cport\u003e\"; Acquire::https::Proxy \"http://\u003cproxy\u003e:\u003cport\u003e\"; /etc/wgetrc http_proxy = http://\u003cproxy\u003e:\u003cport\u003e https_proxy = http://\u003cproxy\u003e:\u003cport\u003e ftp_proxy = http://\u003cproxy\u003e:\u003cport\u003e anaconda3/envs/ proxy_servers: http: http://\u003cproxy server\u003e:\u003cport\u003e https: https://\u003cproxy server\u003e:\u003cport\u003e 次のコマンドで設定内容を確認\n$ conda config --show ",
    "description": "",
    "tags": [
      "linux",
      "bash",
  ...
  },
  {
    ...
    "tags": null,
    "title": "us-keyboard",
    "uri": "/tags/us-keyboard/index.html"
  },
  {
    "content": "",
    "description": "",
